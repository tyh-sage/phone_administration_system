...
<form method="get" action="search_p">    <!-- 数据库查询电话号码 -->
	<fieldset align="center">
		<legend>查询</legend>                                                          <!--  组合表单中的相关元素-->
		<input type="text" class="input" name="phonenumber" placeholder="请输入电话号码~~" />
		<input type="submit" value="确定" class="input2" />
		<input type="reset" value="重置" class="input2" />
	</fieldset>
</form>
<div><img src ="image/s.gif" width="600" height="600"/></div>
</body>
</html>